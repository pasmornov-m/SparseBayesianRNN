...
Так как используемые зависимости на данный момент устарели и практически не поддерживаются, был создан docker образ для запуска оригинального кода.

Также, основная логика предложенной нейронной сети и несколько примеров её работы были перенесены на современную библиотеку Pytorch. 